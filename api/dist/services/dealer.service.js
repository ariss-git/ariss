...
export const registerDealerService = async (phone, email, first_name, last_name, gstin, usertype, shipping_address, apiKey, otp) => {
    try {
...
export const isDealerSignedIn = async (dealer_id) => {
