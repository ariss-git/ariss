...
export class CourseServices {
    ...
    async updateToActiveCourse(courseId) {
    ...
    async updateToInactiveCourse(courseId) {
        return await this.prismaClient.course.update({
            where: {
                course_id: courseId,
            },
    ...
    async updateCourse(courseId, title, content) {
        const existingCourse = await this.prismaClient.course.findUnique({
            where: {
                course_id: courseId,
            },
        ...
        if (!existingCourse)
            throw new Error('Course with this ID do not exist');
