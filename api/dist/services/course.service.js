...
export const addQuestionsToCourse = async (courseId, questions) => {
    try {
...
export const getPassedFailedUsers = async (courseId, status) => {
    try {
...
// Get all questions
export const fetchAllQuestions = async (courseId) => {
