...
export const rmaRequestFormService = async (formData) => {
...
export const rmaRequestAcceptedService = async (rma_id) => {
...
export const rmaRequestRejectedService = async (rma_id) => {
    const existingRMA = await prisma.rMA.findUnique({
        where: { rma_id },
        select: {
            phone: true,
...
export const rmaRequestResolvedService = async (rma_id) => {
    const existingRMA = await prisma.rMA.findUnique({
        where: {
            rma_id,
        },
...
export const getSingleRMAService = async (rma_id) => {
    const existingRMA = await prisma.rMA.findUnique({
        where: {
            rma_id,
        },
...
export const deleteRMARequestService = async (rma_id) => {
    const existingRMA = await prisma.rMA.findUnique({
        where: {
            rma_id,
        },
