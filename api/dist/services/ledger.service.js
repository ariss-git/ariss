 ...
 */
export const createLedgerService = async (product_id, total, balance_due, quantity, user_id, username, usertype, business_name, shipping_address) => {
 ...
 */
export const fetchSingleLedgerService = async (ledger_id) => {
 ...
 */
export const fetchUsersLedgerService = async (user_id) => {
 ...
 */
export const setDueDateService = async (ledger_id, due_date) => {
    const existingLedger = await prisma.ledger.findUnique({
        where: {
            ledger_id,
        },
 ...
 */
export const updateAmountsService = async (ledger_id, amount_paid) => {
 ...
 */
export const cancelLedgerOrderService = async (ledger_id) => {
    const existingLedger = await prisma.ledger.findUnique({
        where: {
            ledger_id,
        },
