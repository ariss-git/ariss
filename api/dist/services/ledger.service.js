...
export class LedgerService {
     ...
     */
    async createLedgerService(product_id, total, balance_due, quantity, user_id, username, usertype, business_name, shipping_address) {
     ...
     */
    async fetchSingleLedgerService(ledger_id) {
     ...
     */
    async fetchUsersLedgerService(user_id) {
     ...
     */
    async setDueDateService(ledger_id, due_date) {
        const existingLedger = await this.prismaClient.ledger.findUnique({
            where: { ledger_id },
        });
        if (!existingLedger) {
     ...
     * @returns   Updated ledger record
     */
    async updateAmountsService(ledger_id, amount_paid) {
     ...
     */
    async cancelLedgerOrderService(ledger_id) {
