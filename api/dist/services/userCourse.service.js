...
export const enrollInCourse = async (courseId, userId, userName, businessName) => {
...
export const takeTest = async (courseId, userId, answers) => {
...
export const getUserResults = async (courseId, userId) => {
...
export const retakeTest = async (courseId, userId) => {
