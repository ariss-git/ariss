...
export const addToWishlistService = async (dealer_id, product_id) => {
    ...
    if (existingWishlist)
        throw new Error('Dealer has already added this to wish list'); // Throw error
...
export const getWishlistProductService = async (dealer_id, product_id) => {
...
export const deleteWishlistService = async (wishlist_id) => {
    // Delete wishlist
