// src/lib/rmaNotifications/rmaResolved.ts
import { config } from '../../config/index.js';
import twilio from 'twilio';
import nodemailer from 'nodemailer';
// Function to send coupon code on whatsapp and email
export const rmaResolved = async (phone, email, product_title) => {
    ...
    try {
        const message = `Confirmation: Your RMA request was accepted and hence successfully resolved for product ${product_title}.`;
