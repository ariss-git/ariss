 ...
 * @route POST /rma
 */
export const rmaRequestFormController = async (req, res) => {
    try {
 ...
 */
export const rmaRequestAcceptedController = async (req, res) => {
    try {
 ...
 */
export const rmaRequestRejectedController = async (req, res) => {
    try {
        const { rma_id } = req.params;
        if (!rma_id) {
            return res.status(404).json({ success: false, message: 'Invalid or Incorrect RMA ID' });
 ...
 */
export const rmaRequestResolvedController = async (req, res) => {
    try {
        const { rma_id } = req.params;
        if (!rma_id) {
            return res.status(404).json({ success: false, message: 'Invalid or Incorrect RMA ID' });
 ...
 */
export const getSingleRMAController = async (req, res) => {
    try {
        const { rma_id } = req.params;
        if (!rma_id) {
            return res.status(404).json({ success: false, message: 'Invalid or Incorrect RMA ID' });
 ...
 */
export const deleteRMARequestController = async (req, res) => {
    try {
        const { rma_id } = req.params;
        if (!rma_id) {
            return res.status(404).json({ success: false, message: 'Invalid or Incorrect RMA ID' });
