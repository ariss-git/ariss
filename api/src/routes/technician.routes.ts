...
technicianRoutes.get(
    '/disapproved/:dealer_id',
    techinicianControllers.getAllDisapprovedTechniciansController
);
...
technicianRoutes.put(
    '/disapprove/:dealer_id/:tech_id',
    techinicianControllers.disapproveTechnicianController
);
