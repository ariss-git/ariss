      ...
      {userType === 'DEALER' && (
        <>
          ...
          <View className="flex-1 flex-col gap-y-6">
            {/* ID */}
            <View>
              <Text className="mt-2 font-worksans text-lg font-semibold text-black">ID</Text>
            ...
            <View>
              ...
              <View className="mt-2 w-full rounded-lg border border-gray-200 px-6 py-4">
                <Text className="font-worksans text-black">+91-{userData.phone}</Text>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              {loading ? (
                ...
                <Text className="text-center text-lg font-semibold text-white">Update Request</Text>
              )}
            </TouchableOpacity>
      ...
      {userType === 'BACKOFFICE' && (
        <>
          ...
          <View>
            <Text className="mt-2 font-worksans text-lg font-semibold text-black">ID</Text>
            <View className="mt-2 w-full rounded-lg border border-gray-200 px-6 py-4">
              <Text className="font-worksans text-black">{userData.backoffice_id}</Text>
            </View>
          </View>
          ...
          <View className="mt-4">
            <Text className="mt-2 font-worksans text-lg font-semibold text-black">Phone</Text>
            <View className="mt-2 w-full rounded-lg border border-gray-200 px-6 py-4">
          ...
          <View className="mt-4">
            <Text className="mt-2 font-worksans text-lg font-semibold text-black">Email</Text>
            <View className="mt-2 w-full rounded-lg border border-gray-200 px-6 py-4">
              <Text className="font-worksans text-black">{userData.email}</Text>
            </View>
          </View>
          ...
          <Text className="mt-4 px-2 text-center text-orange-500">
            To update your details please contact sales person
          </Text>
        </>
      )}
      {userType === 'TECHNICIAN' && (
        <>
          ...
          <View>
            <Text className="mt-2 font-worksans text-lg font-semibold text-black">ID</Text>
            <View className="mt-2 w-full rounded-lg border border-gray-200 px-6 py-4">
              <Text className="font-worksans text-black">{userData.tech_id}</Text>
            </View>
          </View>
