...
const FetchAllApprovedDealers = () => {
    ...
    // Disapprove a dealer
    const handleDisapproval = async (dealer_id: string, business_name: string) => {
        if (!dealer_id) return;
        setLoading(true);
        try {
            ...
            toast({
                ...
                description: 'Dealer has been disapproved successfully.',
...
export default FetchAllApprovedDealers;
